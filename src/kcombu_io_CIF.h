...
struct BLOCK{
  /* The "BLOCK" contains the all of the data in the CIF file. */
...
/* Functions (GLOBAL) */
extern void read_CIF_file_into_BLOCK();
extern void read_CIF_file_into_WORDs();
extern void Translate_Lines_into_WORDs();
extern void translate_CIF_WORDs_into_BLOCK_data();
...
extern void make_rowline_from_temp_head_word_for_one_row_table();
